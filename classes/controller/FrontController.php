...
class FrontControllerCore extends Controller
{
    ...
    public function initContent()
    {
        ...
        if (!$this->useMobileTheme()) {
            ...
            $extra_favicons = '
                <link rel="shortcut icon" sizes="57x57" href="'.__PS_BASE_URI__.'img'.DIRECTORY_SEPARATOR.'favicon_57.png">
                <link rel="shortcut icon" sizes="72x72" href="'.__PS_BASE_URI__.'img'.DIRECTORY_SEPARATOR.'favicon_72.png">
                <link rel="shortcut icon" sizes="114x114" href="'.__PS_BASE_URI__.'img'.DIRECTORY_SEPARATOR.'favicon_114.png">
                <link rel="shortcut icon" sizes="144x144" href="'.__PS_BASE_URI__.'img'.DIRECTORY_SEPARATOR.'favicon_144.png">';
